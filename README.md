...
1. Download [**MovieTagger-1.3.zip**](https://github.com/keitheobrien/movie_tagger/releases/download/v1.3/MovieTagger-1.3.zip) from the [v1.3 release page](https://github.com/keitheobrien/movie_tagger/releases/tag/v1.3) — or grab [the latest release](https://github.com/keitheobrien/movie_tagger/releases/latest) to always get the newest version. From 1.2 onward the app keeps itself up to date automatically.
